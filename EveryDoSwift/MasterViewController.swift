...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate, DetailViewControllerDelegate {
    ...
    func insertNewObject(_ sender: Any) {
        ...
        let defaultTitle = UserDefaults.standard.string(forKey: "default_title_for_todo") ?? "Input to do item here"
        let defaultToDoDescription = UserDefaults.standard.string(forKey: "default_toDoDescription_for_todo") ?? "Input description of your to do item"
